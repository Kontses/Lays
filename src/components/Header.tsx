          ...
          {isSearchOpen && (
            ...
            >
              <svg 
                ...
                style={{ marginRight: '12px', flexShrink: 0, opacity: 0.8 }}
              >
                <path 
                  d="M33.3248 32.1751L28.2396 27.0909C29.7135 25.3214 30.4485 23.0518 30.2916 20.7542C30.1347 18.4566 29.0981 16.3079 27.3974 14.7551C25.6967 13.2023 23.4628 12.365 21.1604 12.4174C18.858 12.4697 16.6645 13.4076 15.036 15.036C13.4076 16.6645 12.4697 18.858 12.4174 21.1604C12.365 23.4628 13.2023 25.6967 14.7551 27.3974C16.3079 29.0981 18.4566 30.1347 20.7542 30.2916C23.0518 30.4485 25.3214 29.7135 27.0909 28.2396L32.1751 33.3248C32.2506 33.4003 32.3403 33.4602 32.4389 33.5011C32.5375 33.5419 32.6432 33.5629 32.75 33.5629C32.8567 33.5629 32.9625 33.5419 33.0611 33.5011C33.1597 33.4602 33.2493 33.4003 33.3248 33.3248C33.4003 33.2493 33.4602 33.1597 33.5011 33.0611C33.5419 32.9625 33.5629 32.8567 33.5629 32.75C33.5629 32.6432 33.5419 32.5375 33.5011 32.4389C33.4602 32.3403 33.4003 32.2506 33.3248 32.1751ZM14.0625 21.375C14.0625 19.9287 14.4914 18.5149 15.2949 17.3124C16.0984 16.1098 17.2404 15.1726 18.5766 14.6191C19.9128 14.0657 21.3831 13.9208 22.8016 14.203C24.2201 14.4851 25.523 15.1816 26.5457 16.2043C27.5684 17.2269 28.2648 18.5299 28.547 19.9484C28.8291 21.3669 28.6843 22.8372 28.1309 24.1734C27.5774 25.5095 26.6401 26.6516 25.4376 27.4551C24.2351 28.2586 22.8213 28.6875 21.375 28.6875C19.4363 28.6853 17.5775 27.9142 16.2066 26.5433C14.8358 25.1724 14.0646 23.3137 14.0625 21.375Z" 
                  fill="white" 
                />
              </svg>
              <Box
